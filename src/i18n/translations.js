export const translations = {
  de: {
    ...
    presets_intro: "Fertige Alarmton-Konfigurationen zum sofortigen Laden. Klicke auf \"Laden\" um ein Preset zu aktivieren.",
    presets_load: "Laden",
    preset_emergency_name: "Klassische Notfallsirene",
    preset_emergency_desc: "Zwei-Ton Hi-Lo Sirene (660/880 Hz) mit Oberwelle — klassischer Rettungsdienst-Alarm.",
    preset_industrial_name: "Industrielles Warnsignal",
    preset_industrial_desc: "Schwerer, tieffrequenter Warnton mit Sägezahn- und Rechteckwellen. Tiefpassfilter mit Resonanzspitze.",
    preset_wakeup_name: "Sanfter Weckalarm",
    preset_wakeup_desc: "Harmonischer C-Dur-Akkord mit langen Ein-/Ausblendzeiten. Ideal als Wecker oder Meditationstimer.",
    preset_heartbeat_name: "Herzmonitor-Alarm",
    preset_heartbeat_desc: "Kurze Doppelpulse simulieren einen medizinischen Monitor. Bandpassfilter fokussiert den typischen Klinik-Sound.",
    preset_scifi_name: "Sci-Fi Stereo-Sweep",
    preset_scifi_desc: "Futuristischer Alarm mit 9 Oszillatoren, Schwebungseffekt und vollem Stereopanorama.",
    ...
    faq_a8: "ADSR beschreibt die Hüllkurve eines Tons: Attack = Anstiegszeit zum Spitzenwert, Decay = Abklingzeit zum Sustain-Pegel, Sustain = Haltepegel während der Ton aktiv ist, Release = Ausklingzeit nach dem Abschalten.",
  ...
  en: {
    ...
    preset_emergency_desc: "Two-tone Hi-Lo siren (660/880 Hz) with overtone — classic emergency services alarm.",
    preset_industrial_name: "Industrial Warning Signal",
    preset_industrial_desc: "Heavy, low-frequency warning tone with sawtooth and square waves. Lowpass filter with resonance peak.",
    preset_wakeup_name: "Gentle Wake-Up Alarm",
    preset_wakeup_desc: "Harmonic C-major chord with long fade-in/fade-out times. Ideal as alarm clock or meditation timer.",
    preset_heartbeat_name: "Heartbeat Monitor Alert",
    preset_heartbeat_desc: "Short double pulses simulate a medical monitor. Bandpass filter focuses the typical clinical sound.",
    preset_scifi_name: "Sci-Fi Stereo Sweep",
    preset_scifi_desc: "Futuristic alarm with 9 oscillators, beat frequency effect, and full stereo panorama.",
    ...
    faq_a8: "ADSR describes the envelope of a sound: Attack = rise time to peak level, Decay = fall time to sustain level, Sustain = hold level while the tone is active, Release = fade-out time after the tone is turned off.",
